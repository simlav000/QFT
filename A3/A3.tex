...
Therefore
\[
\int dt \int d^2\mathbf x \; (\partial_t \phi)^2 =\frac{1}{2V}\sum_{\mathbf p}\sum_{a}\omega_a^2\,|\phi_{\mathbf p}^{\,a}|^2.
\]

Similarly, the gradient term is
\[
\int d^2\mathbf x\,(\nabla\phi)^2
=\frac{1}{V_s}\sum_{\mathbf k,\mathbf q}\phi_{\mathbf k}\phi_{\mathbf q}
\int d^2\mathbf x\,\nabla w_{\mathbf k}\!\cdot\!\nabla w_{\mathbf q}
=\frac{1}{V_s}\sum_{\mathbf k,\mathbf q}\phi_{\mathbf k}\phi_{\mathbf q}
\int d^2\mathbf x\,w_{\mathbf k}(-\nabla^2) w_{\mathbf q}
=\sum_{\mathbf k}\lambda_{\mathbf k}\,|\phi_{\mathbf k}|^2.
\]
